...
(function testUvr5AssetsUseOneCacheVersion(){
  ...
  assert(assetVersion.includes("H2S_STUDIO_ASSET_VERSION = 'cloud-auth-v1'"));
  assert(html.includes('studio_asset_version.js?v=cloud-auth-v1'));
  assert(html.includes('audio_worker_separation_client.js?v=cloud-auth-v1'));
  assert(html.includes('app.js?v=cloud-auth-v1'));
