...
(function testUvr5AssetsUseOneCacheVersion(){
  ...
  assert(assetVersion.includes("H2S_STUDIO_ASSET_VERSION = 'global-shell-v1'"));
  assert(html.includes('studio_asset_version.js?v=global-shell-v1'));
  assert(html.includes('audio_worker_separation_client.js?v=global-shell-v1'));
  assert(html.includes('app.js?v=global-shell-v1'));
