...
(function testUvr5AssetsUseOneCacheVersion(){
  ...
  assert(assetVersion.includes("H2S_STUDIO_ASSET_VERSION = 'audio-clip-name-download-v3'"));
  assert(html.includes('studio_asset_version.js?v=audio-clip-name-download-v3'));
  assert(html.includes('audio_worker_separation_client.js?v=audio-clip-name-download-v3'));
  assert(html.includes('app.js?v=audio-clip-name-download-v3'));
