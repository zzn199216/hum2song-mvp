...
if (fs.existsSync(indexHtmlPath)) {
  ...
  assert(indexHtml.indexOf('studio-startup-loading-v1') !== -1, 'startup loading changes should bump Studio script cache version');
}
...
if (fs.existsSync(assetVersionPath)) {
  ...
  assert(assetVersionSrc.indexOf('studio-startup-loading-v1') !== -1, 'Studio asset version should change for startup loading updates');
}
