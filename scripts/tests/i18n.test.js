...
if (fs.existsSync(indexHtmlPath)) {
  ...
  assert(indexHtml.indexOf('ai-audio-separation-cors-ui-v3') !== -1, 'collapsed AI audio separation controls should bump Studio script cache version');
}
...
if (fs.existsSync(assetVersionPath)) {
  ...
  assert(assetVersionSrc.indexOf('ai-audio-separation-cors-ui-v3') !== -1, 'Studio asset version should change for collapsed audio separation controls');
}
