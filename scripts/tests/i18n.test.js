...
if (fs.existsSync(indexHtmlPath)) {
  ...
  assert(indexHtml.indexOf('ai-audio-separation-v0') !== -1, 'AI audio separation v0 should bump Studio script cache version');
}
...
if (fs.existsSync(assetVersionPath)) {
  ...
  assert(assetVersionSrc.indexOf('ai-audio-separation-v0') !== -1, 'Studio asset version should change for AI audio separation v0');
}
