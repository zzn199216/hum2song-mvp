...
if (fs.existsSync(indexHtmlPath)) {
  ...
  assert(indexHtml.indexOf('audio-download-modal-mixed-wav-v1') !== -1, 'current Studio release should bump the script cache version');
}
...
if (fs.existsSync(assetVersionPath)) {
  ...
  assert(assetVersionSrc.indexOf('audio-download-modal-mixed-wav-v1') !== -1, 'Studio asset version should match the current release');
}
