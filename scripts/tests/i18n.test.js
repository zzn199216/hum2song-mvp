...
if (fs.existsSync(indexHtmlPath)) {
  ...
  assert(indexHtml.indexOf('audio-waveform-separate-before-midi-v1') !== -1, 'audio waveform separation checkbox should bump Studio script cache version');
}
...
if (fs.existsSync(assetVersionPath)) {
  ...
  assert(assetVersionSrc.indexOf('audio-waveform-separate-before-midi-v1') !== -1, 'Studio asset version should change for audio waveform separation checkbox');
}
