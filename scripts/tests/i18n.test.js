...
if (fs.existsSync(indexHtmlPath)) {
  ...
  assert(indexHtml.indexOf('clip-edit-v16') !== -1, 'clip editor release should bump Studio script cache version');
}
...
if (fs.existsSync(assetVersionPath)) {
  ...
  assert(assetVersionSrc.indexOf('clip-edit-v16') !== -1, 'Studio asset version should change for clip editor release');
}
