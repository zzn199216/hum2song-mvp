(function(ROOT){
  ...
  function buildArrangementRepairMessages(reason, detail, previousText){
    ...
    const repairUser = [
      ...
      'Exact addInstance format: {"op":"addInstance","instanceId":"inst_unique_1","clipId":"clip_new_1","trackId":"trk_new_1","startBeat":0}.',
      'Do not use "id" for addInstance. Use instanceId, and make every unique instanceId non-empty.',
