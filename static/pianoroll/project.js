...
(function(){
  ...
  const SAMPLER_PACKS = {
    ...
    'tonejs:guitar-electric': {
      ...
      requiredKeys: ['A3', 'A4', 'A5', 'C3', 'C4', 'C5', 'C6', 'C#2', 'D#3', 'D#4', 'D#5', 'E2', 'F#2', 'F#3', 'F#4', 'F#5'],
      urls: { 'A3': 'A3.mp3', 'A4': 'A4.mp3', 'A5': 'A5.mp3', 'C3': 'C3.mp3', 'C4': 'C4.mp3', 'C5': 'C5.mp3', 'C6': 'C6.mp3', 'C#2': 'Cs2.mp3', 'D#3': 'Ds3.mp3', 'D#4': 'Ds4.mp3', 'D#5': 'Ds5.mp3', 'E2': 'E2.mp3', 'F#2': 'Fs2.mp3', 'F#3': 'Fs3.mp3', 'F#4': 'Fs4.mp3', 'F#5': 'Fs5.mp3' },
    },
    'tonejs:guitar-nylon': {
      label: 'Guitar Nylon (tonejs-instruments)',
      baseUrlDefault: '/static/pianoroll/vendor/tonejs-instruments/samples/guitar-nylon/',
      instrumentSubdir: 'guitar-nylon/',
      requiredKeys: ['A2', 'A3', 'A4', 'A5', 'A#5', 'B1', 'B2', 'B3', 'B4', 'C#3', 'C#4', 'C#5', 'D2', 'D3', 'D5', 'D#4', 'E2', 'E3', 'E4', 'E5', 'F#2', 'F#3', 'F#4', 'F#5', 'G3', 'G5', 'G#2', 'G#4', 'G#5'],
      urls: { 'A2': 'A2.mp3', 'A3': 'A3.mp3', 'A4': 'A4.mp3', 'A5': 'A5.mp3', 'A#5': 'As5.mp3', 'B1': 'B1.mp3', 'B2': 'B2.mp3', 'B3': 'B3.mp3', 'B4': 'B4.mp3', 'C#3': 'Cs3.mp3', 'C#4': 'Cs4.mp3', 'C#5': 'Cs5.mp3', 'D2': 'D2.mp3', 'D3': 'D3.mp3', 'D5': 'D5.mp3', 'D#4': 'Ds4.mp3', 'E2': 'E2.mp3', 'E3': 'E3.mp3', 'E4': 'E4.mp3', 'E5': 'E5.mp3', 'F#2': 'Fs2.mp3', 'F#3': 'Fs3.mp3', 'F#4': 'Fs4.mp3', 'F#5': 'Fs5.mp3', 'G3': 'G3.mp3', 'G5': 'G5.mp3', 'G#2': 'Gs2.mp3', 'G#4': 'Gs4.mp3', 'G#5': 'Gs5.mp3' },
    },
    'tonejs:cello': {
      label: 'Cello (tonejs-instruments)',
      baseUrlDefault: '/static/pianoroll/vendor/tonejs-instruments/samples/cello/',
      instrumentSubdir: 'cello/',
      requiredKeys: ['A2', 'A3', 'A4', 'A#2', 'A#3', 'B2', 'B3', 'B4', 'C2', 'C3', 'C4', 'C5', 'C#3', 'C#4', 'D2', 'D3', 'D4', 'D#2', 'D#3', 'D#4', 'E2', 'E3', 'E4', 'F2', 'F3', 'F4', 'F#3', 'F#4', 'G2', 'G3', 'G4', 'G#2', 'G#3', 'G#4'],
      urls: { 'A2': 'A2.mp3', 'A3': 'A3.mp3', 'A4': 'A4.mp3', 'A#2': 'As2.mp3', 'A#3': 'As3.mp3', 'B2': 'B2.mp3', 'B3': 'B3.mp3', 'B4': 'B4.mp3', 'C2': 'C2.mp3', 'C3': 'C3.mp3', 'C4': 'C4.mp3', 'C5': 'C5.mp3', 'C#3': 'Cs3.mp3', 'C#4': 'Cs4.mp3', 'D2': 'D2.mp3', 'D3': 'D3.mp3', 'D4': 'D4.mp3', 'D#2': 'Ds2.mp3', 'D#3': 'Ds3.mp3', 'D#4': 'Ds4.mp3', 'E2': 'E2.mp3', 'E3': 'E3.mp3', 'E4': 'E4.mp3', 'F2': 'F2.mp3', 'F3': 'F3.mp3', 'F4': 'F4.mp3', 'F#3': 'Fs3.mp3', 'F#4': 'Fs4.mp3', 'G2': 'G2.mp3', 'G3': 'G3.mp3', 'G4': 'G4.mp3', 'G#2': 'Gs2.mp3', 'G#3': 'Gs3.mp3', 'G#4': 'Gs4.mp3' },
    },
    'tonejs:contrabass': {
      label: 'Contrabass (tonejs-instruments)',
      baseUrlDefault: '/static/pianoroll/vendor/tonejs-instruments/samples/contrabass/',
      instrumentSubdir: 'contrabass/',
      requiredKeys: ['A2', 'A#1', 'B3', 'C2', 'C#3', 'D2', 'E2', 'E3', 'F#1', 'F#2', 'G1', 'G#2', 'G#3'],
      urls: { 'A2': 'A2.mp3', 'A#1': 'As1.mp3', 'B3': 'B3.mp3', 'C2': 'C2.mp3', 'C#3': 'Cs3.mp3', 'D2': 'D2.mp3', 'E2': 'E2.mp3', 'E3': 'E3.mp3', 'F#1': 'Fs1.mp3', 'F#2': 'Fs2.mp3', 'G1': 'G1.mp3', 'G#2': 'Gs2.mp3', 'G#3': 'Gs3.mp3' },
    },
    'tonejs:flute': {
      label: 'Flute (tonejs-instruments)',
      baseUrlDefault: '/static/pianoroll/vendor/tonejs-instruments/samples/flute/',
      instrumentSubdir: 'flute/',
      requiredKeys: ['A4', 'A5', 'A6', 'C4', 'C5', 'C6', 'C7', 'E4', 'E5', 'E6'],
      urls: { 'A4': 'A4.mp3', 'A5': 'A5.mp3', 'A6': 'A6.mp3', 'C4': 'C4.mp3', 'C5': 'C5.mp3', 'C6': 'C6.mp3', 'C7': 'C7.mp3', 'E4': 'E4.mp3', 'E5': 'E5.mp3', 'E6': 'E6.mp3' },
    },
    'tonejs:clarinet': {
      label: 'Clarinet (tonejs-instruments)',
      baseUrlDefault: '/static/pianoroll/vendor/tonejs-instruments/samples/clarinet/',
      instrumentSubdir: 'clarinet/',
      requiredKeys: ['A#3', 'A#4', 'A#5', 'D3', 'D4', 'D5', 'D6', 'F3', 'F4', 'F5', 'F#6'],
      urls: { 'A#3': 'As3.mp3', 'A#4': 'As4.mp3', 'A#5': 'As5.mp3', 'D3': 'D3.mp3', 'D4': 'D4.mp3', 'D5': 'D5.mp3', 'D6': 'D6.mp3', 'F3': 'F3.mp3', 'F4': 'F4.mp3', 'F5': 'F5.mp3', 'F#6': 'Fs6.mp3' },
    },
    'tonejs:trumpet': {
      label: 'Trumpet (tonejs-instruments)',
      baseUrlDefault: '/static/pianoroll/vendor/tonejs-instruments/samples/trumpet/',
      instrumentSubdir: 'trumpet/',
      requiredKeys: ['A3', 'A5', 'A#4', 'C4', 'C6', 'D5', 'D#4', 'F3', 'F4', 'F5', 'G4'],
      urls: { 'A3': 'A3.mp3', 'A5': 'A5.mp3', 'A#4': 'As4.mp3', 'C4': 'C4.mp3', 'C6': 'C6.mp3', 'D5': 'D5.mp3', 'D#4': 'Ds4.mp3', 'F3': 'F3.mp3', 'F4': 'F4.mp3', 'F5': 'F5.mp3', 'G4': 'G4.mp3' },
    },
    'tonejs:french-horn': {
      label: 'French Horn (tonejs-instruments)',
      baseUrlDefault: '/static/pianoroll/vendor/tonejs-instruments/samples/french-horn/',
      instrumentSubdir: 'french-horn/',
      requiredKeys: ['A1', 'A3', 'C2', 'C4', 'D3', 'D5', 'D#2', 'F3', 'F5', 'G2'],
      urls: { 'A1': 'A1.mp3', 'A3': 'A3.mp3', 'C2': 'C2.mp3', 'C4': 'C4.mp3', 'D3': 'D3.mp3', 'D5': 'D5.mp3', 'D#2': 'Ds2.mp3', 'F3': 'F3.mp3', 'F5': 'F5.mp3', 'G2': 'G2.mp3' },
    },
    'tonejs:trombone': {
      label: 'Trombone (tonejs-instruments)',
      baseUrlDefault: '/static/pianoroll/vendor/tonejs-instruments/samples/trombone/',
      instrumentSubdir: 'trombone/',
      requiredKeys: ['A#1', 'A#2', 'A#3', 'C3', 'C4', 'C#2', 'C#4', 'D3', 'D4', 'D#2', 'D#3', 'D#4', 'F2', 'F3', 'F4', 'G#2', 'G#3'],
      urls: { 'A#1': 'As1.mp3', 'A#2': 'As2.mp3', 'A#3': 'As3.mp3', 'C3': 'C3.mp3', 'C4': 'C4.mp3', 'C#2': 'Cs2.mp3', 'C#4': 'Cs4.mp3', 'D3': 'D3.mp3', 'D4': 'D4.mp3', 'D#2': 'Ds2.mp3', 'D#3': 'Ds3.mp3', 'D#4': 'Ds4.mp3', 'F2': 'F2.mp3', 'F3': 'F3.mp3', 'F4': 'F4.mp3', 'G#2': 'Gs2.mp3', 'G#3': 'Gs3.mp3' },
    },
    'tonejs:saxophone': {
      label: 'Saxophone (tonejs-instruments)',
      baseUrlDefault: '/static/pianoroll/vendor/tonejs-instruments/samples/saxophone/',
      instrumentSubdir: 'saxophone/',
      requiredKeys: ['A4', 'A5', 'A#3', 'A#4', 'B3', 'B4', 'C4', 'C5', 'C#3', 'C#4', 'C#5', 'D3', 'D4', 'D5', 'D#3', 'D#4', 'D#5', 'E3', 'E4', 'E5', 'F3', 'F4', 'F5', 'F#3', 'F#4', 'F#5', 'G3', 'G4', 'G5', 'G#3', 'G#4', 'G#5'],
      urls: { 'A4': 'A4.mp3', 'A5': 'A5.mp3', 'A#3': 'As3.mp3', 'A#4': 'As4.mp3', 'B3': 'B3.mp3', 'B4': 'B4.mp3', 'C4': 'C4.mp3', 'C5': 'C5.mp3', 'C#3': 'Cs3.mp3', 'C#4': 'Cs4.mp3', 'C#5': 'Cs5.mp3', 'D3': 'D3.mp3', 'D4': 'D4.mp3', 'D5': 'D5.mp3', 'D#3': 'Ds3.mp3', 'D#4': 'Ds4.mp3', 'D#5': 'Ds5.mp3', 'E3': 'E3.mp3', 'E4': 'E4.mp3', 'E5': 'E5.mp3', 'F3': 'F3.mp3', 'F4': 'F4.mp3', 'F5': 'F5.mp3', 'F#3': 'Fs3.mp3', 'F#4': 'Fs4.mp3', 'F#5': 'Fs5.mp3', 'G3': 'G3.mp3', 'G4': 'G4.mp3', 'G5': 'G5.mp3', 'G#3': 'Gs3.mp3', 'G#4': 'Gs4.mp3', 'G#5': 'Gs5.mp3' },
    },
    'tonejs:xylophone': {
      label: 'Xylophone (tonejs-instruments)',
      baseUrlDefault: '/static/pianoroll/vendor/tonejs-instruments/samples/xylophone/',
      instrumentSubdir: 'xylophone/',
      requiredKeys: ['C5', 'C6', 'C7', 'C8', 'G4', 'G5', 'G6', 'G7'],
  ...
  function ensureScoreIds(score){
    ...
    for (const t of score.tracks){
      ...
      for (const n of t.notes){
        if (!n.id || globalNoteIds.has(String(n.id))) n.id = uid('n_');
